...
class StartPage(tk.Frame):
    ...
    def __init__(self, master):
        ...
        self.r = tk.IntVar()
        rbutton1 = tk.Radiobutton(self, text="Euclidean Distance", variable=self.r, value=1, width=20).grid(row=2, column=1)
        rbutton2 = tk.Radiobutton(self, text="Cosine Similarity", variable=self.r, value=2, width=20).grid(row=3, column=1)
        button1 = tk.Button(self, text="OK", command=lambda: master.switch_frame(cosMethod) if self.r==1 else master.switch_frame(eucliMethod), height=1, width=10).grid(row=2, column=3)
